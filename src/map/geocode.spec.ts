...
describe('getFullAddress', () => {
  ...
  test('normal usage', async () => {
    ...
    expect(await getFullAddress([-0.10664, 51.514209])).toBe(
      '133 Fleet Street, City of London, London, EC4A 2BB, United Kingdom',
    )
    expect(await getFullAddress([-2.076843, 51.894799])).toBe(
      '4 Montpellier Drive, Cheltenham, GL50 1TX, United Kingdom',
    )
  })
})
